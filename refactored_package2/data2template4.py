...
def get_imagelink(url="https://earthquake.usgs.gov/earthquakes/eventpage/us70006d0m/pager"):
    """
    ...
    while (url_image2 == ""):
        url_image1 = ""
        driver = webdriver.Chrome(executable_path="/Users/vedantmathur/Downloads/chromedriver")
        driver.get(url)
...
generate_estimation("https://earthquake.usgs.gov/earthquakes/eventpage/us70006d0m/pager", "1.png", "2.png", True, "1.txt")